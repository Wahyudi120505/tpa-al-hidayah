...
public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http
        ...
        .authorizeHttpRequests(auth -> auth
            ...
            .requestMatchers("/report/**", "/files/**", "/api/student-memorization-status/**", "/api/grades/**","/api/student-memorization-status/student/{studentId}","/api/attendance-summary/**").hasAnyRole("PARENT", "ADMIN")
